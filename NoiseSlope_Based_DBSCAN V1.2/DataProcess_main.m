...
load('TBLHC-2.mat');%load geolocation photon data of strong beam
TBLHC1 = TBLHC;
...
load('DBSCAN_data2_filtered.mat');%load DBSCAN filtered result of strong beam
Distance = Distance-Distance(1);% Set the reference distance to the start of the data
Distance_sig = Distance;
height_sig = height;
...
point_num=30000;% filter point number each time
